    ...
    <section className="relative bg-gradient-to-r from-[#1E0D3D] via-[#481E8C] to-[#763CD2] text-white py-20 px-6 text-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-6 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
          ...
          <a 
            href="#book-session"
            className="w-full sm:w-auto bg-white text-[#763CD2] hover:bg-purple-50 font-sans font-bold text-[12.5px] uppercase tracking-wider px-8 py-4 rounded-full flex items-center justify-center gap-2 shadow-xl shadow-black/10 transition-all transform hover:-translate-y-0.5 cursor-pointer"
          >
            <Calendar size={15} className="text-[#763CD2]" />
            Book Your Session
          </a>
